    ...
    **All Robot simulation classes must derive from this class** .
    ...
    def __init__(self, xs0, map=[], * args):
        ...
        * **visualizationInterval** : time-steps interval between two consecutive frames of the animation
        ...
        self.vehicleIcon = VehicleIcon('/home/haadi/Probabilistic_Robotics_Lab/PR_LAB4/DifferentialDrive.png', scale=1, rotation=90) # Image of the robot to be used in the animation. By default it uses the image of a Differential Mobile Robot.
